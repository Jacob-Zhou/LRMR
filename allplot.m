...
for indM = 1:length(models)
    %% plot Overlap Ratio
    compareList22 = { models{indM}, 'FNN_SMD_AUTO', 'SMD', 'WLRR', 'DRFI','RBD', 'HCT', 'MR',...
        'SVO',  'TD', 'GS', 'CB', 'GC', 'SEG',  ...
        'SS', };
    compareList22_name = { models_name{indM}, 'FNN-SMD', 'SMD', 'WLRR', 'DRFI', 'RBD', 'HCT', 'MR',...
        'SVO',  'TD', 'GS', 'CB', 'GC', 'SEG',  ...
        'SS', };
    compareList11 = { models{indM}, 'FNN_SMD_AUTO', 'SMD', 'DSR','MC','HS', ...
        'PCA', 'LR','SLR','LRR','RC', 'SF',...
        'CA', 'FT','SR'};
    compareList11_name =    { models_name{indM}, 'FNN-SMD', 'SMD', 'DSR','MC','HS', ...
    ...
    for j = 1:length(datasetList)
        ...
        tag = tag11; % ±Í«©
        tagSet = gridLegend(hdl7, 3,tag,'FontSize', 20,'Orientation','Horizontal','location','north');
        set(tagSet, 'Position',[0.1 0.13 0.52 0.2]);
        ...
        ylabel('Precision','FontWeight','bold','FontSize',24);
        tag = tag22; % ±Í«©
        tagSet = gridLegend(hdl8, 3,tag,'FontSize', 20,'Orientation','Horizontal','location','north');
        set(tagSet, 'Position',[0.1 0.13 0.52 0.2]);
        ...
        tag = tag11; % ±Í«©
        tagSet = gridLegend(hdl3, 6, tag, 'FontSize', 20,'Orientation','Horizontal','location','north');
        ...
        tag = tag22; % ±Í«©
        tagSet = gridLegend(hdl4, 6, tag, 'FontSize', 20,'Orientation','Horizontal','location','north');
        set(tagSet, 'Position',[0.11 0.87 0.84 0.1]);
